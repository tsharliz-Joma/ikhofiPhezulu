          ...
          <Box component={"form"} onSubmit={handleCoffeeSubmit} sx={{ mt: 0, width: "100%" }}>
            ...
            <Box>
              ...
              <FormControl fullWidth required sx={{ mt: 1 }}>
                ...
                <Select labelId="coffee" label="coffee" name="coffee" value={formData.coffee} onChange={handleChange}>
            ...
            <FormControl fullWidth required sx={{ mt: 2 }}>
              ...
              <Select labelId="size" label="size" name="coffeeSize" value={formData.coffeeSize} onChange={handleChange}>
            ...
            <FormControl fullWidth required sx={{ mt: 2 }}>
              ...
              <Select labelId="milk" label="milk" name="coffeeMilk" value={formData.coffeeMilk} onChange={handleChange}>
            ...
            <FormControl fullWidth sx={{ mt: 2 }}>
              ...
              <Select labelId="sugar" label="sugar" name="coffeeSugar" value={formData.coffeeSugar} onChange={handleChange}>
