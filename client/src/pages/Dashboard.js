...
// okay so i think here in the front end i use socket IO, to receive the order
// and send out notifications
// i will use mongo to register users and admins 
// as well as take stock of milk and number of coffees

// const socketA = io.connect("http://localhost:1969", {
//   // forceNew: true,
// });


// Backend url ( url that the backend is running on )
